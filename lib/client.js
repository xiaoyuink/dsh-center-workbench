...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function Browser(props) {
      ...
      function openMenu(e, path, isDir) {
        e.preventDefault();
        e.stopPropagation();
        lastMenuPos = { x: e.clientX, y: e.clientY };
        setSelected([path]);
        setAnchor(path);
        setMenu({ x: e.clientX, y: e.clientY, path: path, isDir: !!isDir });
      }
      ...
      return createElement("div", { ref: props.rootRef, className: "dsh-cs-browser", style: props.style }, [
        ...
        menu ? [
          ...
          createElement("div", { className: "dsh-cs-menu", key: "m", style: { left: menu.x, top: menu.y }, onContextMenu: function (e) { e.preventDefault(); } }, [
            createElement("button", { type: "button", className: "dsh-cs-menu-item", onClick: function () { onCopy([menu.path]); setMenu(null); } }, "复制"),
            createElement("button", { type: "button", className: "dsh-cs-menu-item", onClick: function () { onCut([menu.path]); setMenu(null); } }, "剪切"),
            ...
            createElement("button", { type: "button", className: "dsh-cs-menu-item dsh-cs-menu-item-danger", onClick: function () { onDelete([menu.path]); setMenu(null); } }, "删除"),
          ]),
        ] : null,
      ]);
    }
    ...
    function Panel(props) {
      ...
      function doDelete(paths) {
        ...
        confirmDlg(msg).then(function (ok) {
          if (!ok) return;
          (function next(i) {
            if (i >= list.length) { setRefreshToken(function (x) { return x + 1; }); return; }
