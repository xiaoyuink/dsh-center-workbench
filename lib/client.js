...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var FILE_ICON_MAP = Object.assign({},
      iconSet(ICON_IMAGE, "#A074C4", ["png", "jpg", "jpeg", "gif", "webp", "bmp", "ico", "avif", "heic", "tif", "tiff", "svg"]),
      ...
      iconSet(ICON_DOC, "#3B7BBF", ["doc", "docx", "xls", "xlsx", "ppt", "pptx", "odt", "ods", "odp"]),
    ...
    function Browser(props) {
      ...
      if (entries) {
        for (var j = 0; j < entries.length; j++) {
          ...
          const size = ent.size;
          const index = j;
          const ic = fileIconOf(ent.name, isDir);
          rows.push(createElement("button", {
            ...
            createElement("span", { className: "dsh-cs-row-icon" }, Icon(ic.d, ic.c)),
