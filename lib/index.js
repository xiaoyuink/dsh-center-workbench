...
export function apply(ctx) {
  ...
  registerVendorStatic('/api/dsh-center-workbench/vendor/jszip.js', jszipFile, 'application/javascript; charset=utf-8')
  registerVendorStatic('/api/dsh-center-workbench/vendor/docx-preview.js', docxFile, 'application/javascript; charset=utf-8')
  registerVendorStatic('/api/dsh-center-workbench/vendor/xlsx.js', xlsxFile, 'application/javascript; charset=utf-8')
  registerVendorStatic('/api/dsh-center-workbench/vendor/pptx-preview.js', fileURLToPath(new URL('./vendor/pptx-preview.bundle.js', import.meta.url)), 'application/javascript; charset=utf-8')
  ...
  registerVendorStatic('/api/dsh-center-workbench/vendor/pako.js', pakoFile, 'application/javascript; charset=utf-8')
  registerVendorStatic('/api/dsh-center-workbench/vendor/utif.js', req.resolve('utif'), 'application/javascript; charset=utf-8')
  registerVendorStatic('/api/dsh-center-workbench/vendor/heic2any.js', req.resolve('heic2any'), 'application/javascript; charset=utf-8')
  registerVendorStatic('/api/dsh-center-workbench/vendor/ag-psd.js', agpsdFile, 'application/javascript; charset=utf-8')
}
